...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] bg-black  flex flex-col items-center py-0 md:py-80 justify-start shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#010101] bg-gray-200 dark:bg-[#272729] rounded-2xl p-2 relative"
      ></div>
      <motion.div
        style={{
          scaleX: scaleX,
